...
class Ui_LibReplaceDirectory(object):
    def setupUi(self, LibReplaceDirectory):
        ...
        LibReplaceDirectory.resize(614, 70)
        ...
        self.LibReplaceDirectoryFrame = QHBoxLayout(LibReplaceDirectory)
        self.LibReplaceDirectoryFrame.setSpacing(0)
        self.LibReplaceDirectoryFrame.setObjectName(u"LibReplaceDirectoryFrame")
        self.LibReplaceDirectoryFrame.setContentsMargins(0, 0, 0, 0)
        self.IconFrame = QFrame(LibReplaceDirectory)
        ...
        self.IconFrame.setMinimumSize(QSize(45, 0))
        self.IconFrame.setMaximumSize(QSize(45, 16777215))
        self.IconFrame.setFrameShape(QFrame.Shape.NoFrame)
        self.IconFrame.setFrameShadow(QFrame.Shadow.Raised)
        self.gridLayout = QGridLayout(self.IconFrame)
        self.gridLayout.setSpacing(0)
        self.gridLayout.setObjectName(u"gridLayout")
        self.gridLayout.setContentsMargins(11, 24, 11, 24)
        ...
        self.LibReplaceDirectoryFrame.addWidget(self.IconFrame)

        self.DirectoryComponentFrame = QFrame(LibReplaceDirectory)
        ...
        self.LibReplaceDirectoryFrame.addWidget(self.DirectoryComponentFrame)
    ...
    def retranslateUi(self, LibReplaceDirectory):
        ...
        self.Directory.setText(QCoreApplication.translate("LibReplaceDirectory", u"\u6d4b\u8bd5\u76ee\u5f55", None))
        self.Date.setText(QCoreApplication.translate("LibReplaceDirectory", u"\u4e0a\u6b21\u66f4\u65b0\u65f6\u95f4", None))
    # retranslateUi
