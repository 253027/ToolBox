...
class Ui_LibReplace(object):
    def setupUi(self, LibReplace):
        ...
        sizePolicy1.setHeightForWidth(self.ScrollAreaFrame.sizePolicy().hasHeightForWidth())
        self.ScrollAreaFrame.setSizePolicy(sizePolicy1)
        ...
        self.ScrollAreaWidgetContentsLayout.setSpacing(4)
        self.ScrollAreaWidgetContentsLayout.setObjectName(u"ScrollAreaWidgetContentsLayout")
        self.ScrollAreaWidgetContentsLayout.setContentsMargins(10, 0, 10, 0)
